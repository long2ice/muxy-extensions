...
// SF Symbol names, used where Muxy renders a system symbol (the editor tab via
// muxy.tabs.setIcon). The file tree uses the stroke-path icons below instead.
const BY_EXT = {
  md: "doc.richtext",
...
// Stroke-path icons for the file tree. Each entry is a paths array for
// icon_svg() — single-color (currentColor), 1.5px stroke, 24×24 viewBox — so
// the tree tracks the live theme instead of shipping a colored icon set. Files
// are grouped into a handful of visually distinct shapes by category rather
// than one glyph per language, which keeps the set legible at 14px.

// A generic document outline, used as the base every category builds on.
const DOC = { d: "M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" };
const DOC_FOLD = { d: "M14 3v6h6" };

// <> braces — code source files.
const CODE = [DOC, DOC_FOLD, { d: "M10.5 13l-1.5 1.5 1.5 1.5" }, { d: "M14 13l1.5 1.5-1.5 1.5" }];
// # heading bars — markup / prose.
const MARKUP = [DOC, DOC_FOLD, { d: "M8 13h8" }, { d: "M8 16h5" }];
// brush stroke — stylesheets.
const STYLE = [DOC, DOC_FOLD, { d: "M8.5 17c0-2 1.5-2.5 3-3.5s2-2 2-2" }, { kind: "circle", cx: "14.5", cy: "12", r: "1" }];
// key/value rows — structured config & data.
const CONFIG = [DOC, DOC_FOLD, { d: "M8 13h2" }, { d: "M12 13h4" }, { d: "M8 16h2" }, { d: "M12 16h4" }];
// gear — environment / dotfile config.
